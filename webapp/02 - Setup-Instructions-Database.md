...
*   Page:
    ...
    [Deploy A Containerized Dotnet Azure WebApp Using Azure Pipelines](/wiki/spaces/TECH/pages/229382/Deploy+A+Containerized+Dotnet+Azure+WebApp+Using+Azure+Pipelines)